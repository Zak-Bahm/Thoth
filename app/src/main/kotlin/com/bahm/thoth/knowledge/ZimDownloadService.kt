...
class ZimDownloadService @Inject constructor(
    ...
    companion object {
        private const val TAG = "ZimDownload"
    ...
    fun download(url: String, filename: String): Flow<DownloadProgress> = flow {
        ...
        // Get total file size with a HEAD request
        ...
        // Download chunks with concurrency limited by semaphore
        ...
        coroutineScope {
            ...
            // Poll progress while chunks download
            ...
            // Await all to propagate exceptions
        ...
        // Merge chunks into the target file
    ...
    fun getDownloadDir(): File {
        val dir = File(context.getExternalFilesDir(null), "zim")
